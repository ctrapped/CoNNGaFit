...
from Datasets_600x600 import CoNNGaFitImageDataset

from NeuralNetwork_Unet3d_600x600 import NeuralNetwork
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
####Trains the 600x600 Unet variant read from NeuralNetwork_Unet3d_600x600.py on the given training data. Provides additional diagnostic plots and images on the validation and test datasets provided.
####Training, Validation, and testing datasets must be provided in .csv format as outlined in Datasets_600x600.py.
...
#
####Run as: python TrainModel_MassFlux_UNet_HiResTest2.py [options]
