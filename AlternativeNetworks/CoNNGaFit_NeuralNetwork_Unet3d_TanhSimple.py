...
class Upsample(nn.Module):
    def __init__(self, in_channels, out_channels, upsample,kernel1):
        ...
        #self.shortcut = nn.ConvTranspose3d(in_channels, out_channels,kernel_size=(1,1,1),stride=(2,2,2)),
            #nn.BatchNorm3d(out_channels)
...
class NeuralNetwork(nn.Module):
    def __init__(self, nFilt0, kernel0, kernel1, nFC):
        ...
        self.layer1 = ResidualBlock(nFilt0,nFilt0,downsample=False,kernel1=kernel1)
        self.layer2 = ResidualBlock(nFilt0,2*nFilt0,downsample=True,kernel1=kernel1)
        self.layer3 = ResidualBlock(2*nFilt0,4*nFilt0,downsample=True,kernel1=kernel1)
        ...
        self.dc_layer2 = DeconvBlock(4*nFilt0,2*nFilt0,upsample=True,kernel1=kernel1) ##Upsample
