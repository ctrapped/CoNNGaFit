...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the CoNNGaFit 3-d U-Net to predict radial mass flux maps from HI datacubes.")
    parser.add_argument('--sample-suffix', default='All_Inclinations_finalSnapNoM12m',
    ...
    parser.add_argument('--training-csv', default=None,
                         help="Training annotations CSV filename, read from <data-dir>/annotation_datasets/. Default: training_annotations_MassFlux_<sample-suffix>.csv")
    parser.add_argument('--validation-csv', default=None,
                         help="Validation annotations CSV filename, read from <data-dir>/annotation_datasets/. Default: validation_annotations_MassFlux_<sample-suffix>.csv")
    parser.add_argument('--testing-csv', default=None,
                         help="Test annotations CSV filename, read from <data-dir>/annotation_datasets/. Default: test_annotations_MassFlux_<sample-suffix>.csv")
...
trainingSetFilename = args.training_csv or 'training_annotations_MassFlux_'+sampleSuffix+'.csv'
validationSetFilename = args.validation_csv or 'validation_annotations_MassFlux_'+sampleSuffix+'.csv'
testingSetFilename = args.testing_csv or 'test_annotations_MassFlux_'+sampleSuffix+'.csv'
