...
class NeuralNetwork(nn.Module):
    """High-resolution variant of CoNNGaFit_NeuralNetwork_Unet3d.NeuralNetwork: same 3-d
    ...
    CoNNGaFit_NeuralNetwork_Unet3d.py's NeuralNetwork docstring for why these would need to be
    ...
    def forward(self, x, saveLatentImages=False):
        """See CoNNGaFit_NeuralNetwork_Unet3d.NeuralNetwork.forward for the parameter/return
