...
class NeuralNetwork(nn.Module):
    ...
    def forward(self, x, saveLatentImages=False):
        ...
        x = x + featureMap3[:,:,:,0:3,0:3] #Feature forwarding from left convolutional -> deconvolutional wing
       ...
       # print("Shape of x=",np.shape(x),"... Shape of featureMap2=",np.shape(featureMap2))
        ...
        x = x + featureMap2[:,:,0:9,1:6,1:6] #Cropped Feature forwarding
